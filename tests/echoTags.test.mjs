...
// computedInfo.ts/displayRows.ts/reviewOverrides.ts each build their own
// public parser on top of — see those three's own test files for the
// end-to-end behavior (dedup semantics, public shapes) this module doesn't
// own itself.
