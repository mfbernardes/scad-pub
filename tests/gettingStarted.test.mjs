...
test("deriveChecklistItems: 'Adjust the essential settings' completes only on a real param edit", () => {
...
test("deriveChecklistItems: 'Download the model' completes only on a real successful export", () => {
