...
// without a worker/fetch/postMessage environment (see tests/progressThrottle.
// test.mjs). worker.ts owns the actual read-and-post loop (readWithProgress);
// this only owns the decision of WHEN to call the post callback it's given.
