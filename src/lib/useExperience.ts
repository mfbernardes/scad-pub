...
// view" (see docs/config.md's `ui.experience`). App.tsx consumes this hook
// to read/write both states without also owning their resolution rules.
//
...
// Route through `unknown` (see i18n.ts): the raw literal can't structurally
// satisfy Schema once a deployment adds `presetImages`; runtime validation
// lives in schema.ts.
