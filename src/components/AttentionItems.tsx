...
// flagged notice category with a pending notice. Used by ReviewDialog.
// Ported (simplified) from a donor branch's design-reference component: no
// i18n (plain English), no "go to setting" action (ReviewDialog is not
// anchored near any particular control, but the donor's third action isn't
// part of this repo's simpler surface set either — Import font / Use a
