...
// The "View messages" action shared by the notice and bare-diagnostic cards:
// both open the Output console (Messages). Identical markup either way.
function ViewMessagesButton({ onOpenMessages }: { onOpenMessages: () => void }) {
  return (
...
export function AttentionItems({
  ...
  return (
    <div
      className="attention-card flex flex-col gap-3 rounded-lg border border-warn/50 bg-warn-bg px-4 py-3"
      role="status"
    >
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1">
              {item.kind === "font-fallback" ? (
                ...
                <>
                  ...
                  <ViewMessagesButton onOpenMessages={onOpenMessages} />
                </>
              ) : (
