...
function Slider({
  ...
  return (
    ...
    >
      ...
      >
        {/* Dark theme's filled range against the track is 2.67:1, under SC
            1.4.11's 3:1 — a deliberate choice: the bordered thumb, not this
            fill, is what 1.4.11 actually has to carry the current value. */}
