        ...
        >
          ...
          {showCloseButton && (
            <DialogPrimitive.Close
              ...
              // Padding cancelled by negative margin: grows the hit area to
              // 24px (44 on a coarse pointer, 2.5.8) without moving the glyph,
              // which shrink-wrapped its 16px icon.
