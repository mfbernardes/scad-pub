...
interface Props {
  ...
  /** Wave 2 (guided shell): forwarded to ParamRows — see its own `guided` doc. */
  guided?: boolean;
}

export const ParamForm = memo(function ParamForm({ design, values, onChange, search = "", showVarName = false, availableFontFamilies, fontSuggestion, installedFonts, baseline, changedParams, presetName, view = "all", focusParam, guided = false }: Props) {
