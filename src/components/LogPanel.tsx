...
// config-driven advisory categories (each in its configured colour) and for
...
// like the rest of the `colors`/advisory colour config).
...
export function LogPanel({
  ...
  const badges = countBadges(log, advisories);
  return (
