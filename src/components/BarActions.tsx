...
// Exported so GuidedMobileHeader's own theme row (its overflow menu is a
// distinct DropdownMenu, not this component's collapsed Popover — see its
// own doc — so it can't just render <BarActions collapse> in place) uses the
// exact same icon-per-mode mapping instead of keeping its own copy.
export const THEME_ICON: Record<ThemeMode, React.ReactNode> = {
