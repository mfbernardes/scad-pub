...
`src/generated/designs.json`, `public/scad/`, `public/wasm/`, and the generated PWA assets (`public/manifest.webmanifest`, `public/icon.svg`, `public/icon-*.png`, `public/apple-splash-*.png`, `public/precache-manifest.json`) are **gitignored / generated** — never edit them by hand; change the config or sources and re-run. (`public/sw.js` is hand-written and tracked.)
